...
export default function RagisterCandidate() {
    ...
    const handleSubmit=async(e)=>{
        ...
        await contractInstance?.registerCandidate(namer,partyr,ager,genderr).then((data)=>{
            console.log(data);
  ...
  return (
    <div>
        ...
        <form action="" onSubmit={handleSubmit}>
            ...
            <input ref={party}type="text" placeholder='Party' />
